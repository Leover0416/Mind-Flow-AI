...
const EmptyAgentChatView: React.FC<DefaultAgentChatViewProps> = ({
  ...
  const { state } = useLocation() as { state?: { selectedAgentId?: string } };
        ...
        <div className="max-w-2xl w-full space-y-6">
          ...
          <Space orientation="vertical" size="large" className="w-full">
            <Card
              ...
              onClick={() =>
                fillQuickPrompt("你好，请先介绍一下你能做什么，并给我一个使用示例。")
              }
            >
              <Space size="middle">
            ...
            <Card
              ...
              className="cursor-pointer transition-all hover:shadow-lg"
              onClick={() =>
                fillQuickPrompt("请基于我上传到知识库的文档，帮我总结核心要点。")
              }
            >
              <Space size="middle">
            ...
            <Card
              hoverable
              className="cursor-pointer transition-all hover:shadow-lg"
              onClick={() => fillQuickPrompt("帮我快速开始，告诉我第一步该做什么。")}
            >
              <Space size="middle">
        ...
        <div className="px-4 pb-4 pt-4">
          <Sender
            onSubmit={async (value: any) => {
              const content =
                typeof value === "string" ? value : (value?.text ?? message);
